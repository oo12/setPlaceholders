...
$_lang['prop_sph.ph_sortby'] = 'Sort by criterion. Used with child and sibling selectors.<br><strong>Default:</strong> menuindex';
$_lang['prop_sph.ph_sortdir'] = 'Sort direction. Used with child and sibling selectors.<br><strong>Default:</strong> ASC';
